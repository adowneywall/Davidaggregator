...
### Parse single DAVID file 
# file is full path to single data file
output_folder <- '~/path/to/outputfolder'
file <- '~/path/to/file'
df <- file_process(file)
write_tsv(x = df,path = paste0(output_folder,'/AggregateDavidOutput.tsv'))
